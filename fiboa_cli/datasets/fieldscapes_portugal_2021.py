...
URI = "/home/byteboogie/work/labwork_hkerner/fieldscapes/portugal/boundaries_portugal_2021.gpkg"

# Unique identifier for the collection
ID = "fieldscapes_portugal_2021"
# Title of the collection
TITLE = "Field boundaries for Portugal (Fieldscapes)"
# Description of the collection. Can be multiline and include CommonMark.
DESCRIPTION = """ The dataset contains field boundaries for the Portugal."""
# Bounding box of the data in WGS84 coordinates
BBOX = [-31.26635966232626, 39.37398627777968, -31.08573040180035, 39.71924282541468]

# Provider name, can be None if not applicable, must be provided if PROVIDER_URL is provided
PROVIDER_NAME = "Land Occupations – Parcel Identification System (iSIP) – IFAP"
...
ATTRIBUTION = "Institute of Agriculture and Fisheries Financing, IP"
